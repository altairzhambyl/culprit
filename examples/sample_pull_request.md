...
```diff
diff --git a/.culprit-metrics-smoke.json b/.culprit-metrics-smoke.json
new file mode 100644
index 0000000..00f0326
--- /dev/null
+++ b/.culprit-metrics-smoke.json
@@ -0,0 +1,8 @@
+{
+  "f1": 0.8111,
+  "auc": 0.939,
